{
	 ...
	 "modifiedBy":"",
	 "modifiedDate":"",
	 "sourceTables":"MBF_DATALAKE.MSC_CENTER",
	 "sqlStatements": [
	  {
		"sql"      : "
						SELECT
							...
							SELECT 	
								...
								CASE 
									WHEN A.CALL_TYPE_DETAIL IN('MOC','RCA','TSO','TSC','TCA','MFWD') THEN
											CASE WHEN A.IMSI NOT LIKE '452%' 																			THEN 'VOICE_RMNG_ISD_OG'									 
												 ...
												 WHEN (NVL(C.PLMN_ID,'') = '1' OR (C.PLMN_ID IS NULL AND A.PLMN_PLMN_ID = '1')) 						THEN 'VOICE_ONNET_OG'												 
												 WHEN (C.PLMN_ID IS NOT NULL AND C.PLMN_ID <> '1') OR
													 (C.PLMN_ID IS NULL AND A.BCT_PLMN_ID IS NOT NULL AND A.BCT_CALL_TYPE_ID IN('5504','6884','5013','5025',
													 '5023','5014', '278','6844','298','5198','5178','5179','5484'))									THEN 'VOICE_OFFNET_OG'													 
												 WHEN A.BCT_PLMN_ID IS NOT NULL AND A.BCT_CALL_TYPE_ID NOT IN('5504','6884','5013','5025','5023','5014',
													 '278','6844','298','5198','5178','5179','5484')													THEN 'VOICE_PSTN_OG'
									...
									WHEN A.CALL_TYPE_DETAIL IN('MTC','TSI') THEN
											CASE WHEN A.IMSI NOT LIKE '452%' 																			THEN 'VOICE_RMNG_ISD_IC'									 
												 ...
												 WHEN (NVL(C.PLMN_ID,'') = '1' OR (C.PLMN_ID IS NULL AND A.PLMN_PLMN_ID = '1')) 						THEN 'VOICE_ONNET_IC'												 
												 WHEN (C.PLMN_ID IS NOT NULL AND C.PLMN_ID <> '1') OR
													 (C.PLMN_ID IS NULL AND A.BCT_PLMN_ID IS NOT NULL AND A.BCT_CALL_TYPE_ID IN('5504','6884','5013','5025',
													 '5023','5014', '278','6844','298','5198','5178','5179','5484'))									THEN 'VOICE_OFFNET_IC'													 													 
												 WHEN A.BCT_PLMN_ID IS NOT NULL AND A.BCT_CALL_TYPE_ID NOT IN('5504','6884','5013','5025','5023','5014',
													 '278','6844','298','5198','5178','5179','5484')													THEN 'VOICE_PSTN_IC'
									...
									WHEN A.CALL_TYPE_DETAIL = 'SMO' THEN
											CASE WHEN A.IMSI NOT LIKE '452%' 																			THEN 'SMS_RMNG_ISD_OG'
												 ...
												 WHEN (NVL(C.PLMN_ID,'') = '1' OR (C.PLMN_ID IS NULL AND A.PLMN_PLMN_ID = '1')) 				    	THEN 'SMS_ONNET_OG'
												 WHEN (C.PLMN_ID IS NOT NULL AND C.PLMN_ID <> '1') OR (C.PLMN_ID IS NULL AND A.BCT_PLMN_ID IS NOT NULL)	THEN 'SMS_OFFNET_OG'												 
									...
									WHEN A.CALL_TYPE_DETAIL = 'SMT' THEN
											CASE WHEN A.IMSI NOT LIKE '452%' 																			THEN 'SMS_RMNG_ISD_IC'									 
												 ...
												 WHEN (NVL(C.PLMN_ID,'') = '1' OR (C.PLMN_ID IS NULL AND A.PLMN_PLMN_ID = '1')) 						THEN 'SMS_ONNET_IC'
												 WHEN (C.PLMN_ID IS NOT NULL AND C.PLMN_ID <> '1') OR (C.PLMN_ID IS NULL AND A.BCT_PLMN_ID IS NOT NULL)	THEN 'SMS_OFFNET_IC'												 
								...
								CASE 
									WHEN A.CALL_TYPE_DETAIL IN ('MOC','MTC','RCA','TSI','TSO','TSC','TCA','MFWD') THEN
											CASE WHEN A.IMSI NOT LIKE '452%' 														THEN 'VOICE_RMNG_ISD'									 
												 ...
												 WHEN A.PLMN_PLMN_ID = '1' OR A.BCT_PLMN_ID IS NOT NULL								THEN 'VOICE_LOCAL'					 
									...
									WHEN A.CALL_TYPE_DETAIL IN('SMO','SMT') THEN
											CASE WHEN A.IMSI NOT LIKE '452%' 														THEN 'SMS_RMNG_ISD'									 
												 ...
												 WHEN A.PLMN_PLMN_ID = '1' OR A.BCT_PLMN_ID IS NOT NULL								THEN 'SMS_LOCAL'					 
								...
								CASE 
									WHEN A.CALL_TYPE_DETAIL IN ('MOC','MTC','RCA','TSI','TSO','TSC','TCA','MFWD') THEN
											CASE WHEN A.IMSI NOT LIKE '452%' 														THEN 'VOICE_RMNG_ISD'									 
												 WHEN A.IMSI NOT LIKE '45201%' 														THEN 'VOICE_RMNG_LOCAL'
												 WHEN (NVL(C.PLMN_ID,'') = '1' OR (C.PLMN_ID IS NULL AND A.PLMN_PLMN_ID = '1')) 	THEN 'VOICE_LOCAL_ONNET'
												 WHEN (C.PLMN_ID IS NOT NULL AND C.PLMN_ID <> '1') OR
												 (C.PLMN_ID IS NULL AND A.BCT_PLMN_ID IS NOT NULL)									THEN 'VOICE_LOCAL_OFFNET'													 
												 WHEN A.PLMN_PLMN_ID IS NOT NULL AND A.BCT_PLMN_ID IS NULL      					THEN 'VOICE_ISD'	  		 
											ELSE 'UNKNOWN' END											
									WHEN A.CALL_TYPE_DETAIL IN('SMO','SMT') THEN
											CASE WHEN A.IMSI NOT LIKE '452%' 														THEN 'SMS_RMNG_ISD'									 
								...
								CASE WHEN C.PLMN_ID IS NOT NULL 			 THEN CAST(C.PLMN_ID AS STRING) 
									 WHEN A.BCT_PLMN_ID IS NOT NULL  		 THEN CAST(A.BCT_PLMN_ID AS STRING)	
									 WHEN A.PLMN_PLMN_ID IS NOT NULL 		 THEN CAST(A.PLMN_PLMN_ID AS STRING)	
								ELSE CAST(NULL AS STRING) END	AS PLMN_CD,								
									 
								CASE WHEN C.PLMN_ID IS NOT NULL			 																		THEN 'MOBILE'
									 WHEN A.BCT_PLMN_ID IS NOT NULL AND A.BCT_CALL_TYPE_ID IN('5504','6884','5013','5025','5023','5014',
														 '278','6844','298','5198','5178','5179','5484') 										THEN 'MOBILE'
									 WHEN A.BCT_PLMN_ID IS NOT NULL AND A.BCT_CALL_TYPE_ID NOT IN('5504','6884','5013','5025','5023','5014',
														 '278','6844','298','5198','5178','5179','5484') 										THEN 'PSTN'
									 WHEN A.PLMN_PLMN_ID IS NOT NULL 																			THEN 'IRP'
								ELSE CAST(NULL AS STRING) END	AS CSP_TYP_CD	 												 
							FROM (
								SELECT A.* FROM MBF_DATALAKE.MSC_CENTER A WHERE A.DAY_KEY='$day_key' AND ((A.CALL_TYPE IN('OG','IC','DV') AND A.DURATION > 0) OR A.CALL_TYPE IN('SMO','SMT'))
							) A 								
							LEFT JOIN MBF_DATALAKE.MNP_ISDN B 
								ON A.CALLED_ISDN_STD = B.ISDN AND B.STATUS = '1' AND B.DAY_KEY = '$day_key'
								AND UNIX_TIMESTAMP(B.IN_NET_DATE, 'yyyy-MM-dd HH:mm:ss.S') <= UNIX_TIMESTAMP('$day_key', 'yyyyMMdd')
								AND UNIX_TIMESTAMP('$day_key', 'yyyyMMdd') <= CASE WHEN (B.OUT_NET_DATE IS NULL OR B.OUT_NET_DATE = '') THEN UNIX_TIMESTAMP('$day_key', 'yyyyMMdd') ELSE UNIX_TIMESTAMP(B.OUT_NET_DATE, 'yyyy-MM-dd HH:mm:ss.S') END							
		...
		"sql"      : "
				...
				FROM (
						SELECT 
							...
							CASE WHEN A.CALL_TYP_CD LIKE '%ONNET%' THEN '1' 
								 WHEN A.CALL_TYP_CD LIKE '%OFFNET%' THEN '0'								
						...
						ON A.CALLING_ISDN_STD = B.SERVICE_NBR AND B.DAY_KEY = '$day_key'
						LEFT JOIN MBF_BIGDATA.ADMR_CELL C ON C.CELL_KEY = A.CELL_ID_STD AND C.DAY_KEY = '$day_key'
						LEFT JOIN MBF_BIGDATA.ADMR_EXTERNAL_CSP D ON A.PLMN_CD = D.PLMN_CD AND A.CSP_TYP_CD = D.CSP_TYP_CD AND D.DAY_KEY = '$day_key'		
