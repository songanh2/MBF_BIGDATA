	 ...
	 "sqlStatements": [
	  {
		"sql"      	:"
						SELECT
							...
							1 														AS WRHS_ID
						FROM
							MBF_DATALAKE.ACTION_AUDIT A
						LEFT JOIN MBF_BIGDATA.ADMD_SERVICE_TWIN_CLM_ACTVTY B ON
							CAST(CONCAT('2',A.PK_ID) AS STRING) = CAST(B.ACCT_KEY AS STRING) AND B.DAY_KEY='$day_key'
						WHERE A.ACTION_ID = '00' AND A.REASON_ID IN ('179', '6083', '6603', '6623', '6703', '6725')						
